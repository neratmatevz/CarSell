...
<html lang="en">
    ...
    <body>
        ...
        <div id="login">
            <h3 class="text-center text-dark pt-5 mb-5">LOGIN FORM</h3>
            <div class="container">
                        ...
                        <div id="login-box" class="col-md-12">
                            <form id="login-form" class="form" action="" method="POST">
                                ...
                                <div class="form-group clearfix">
                                    ...
                                    <input type="submit" name="submit" class="btn btn-info btn-md m-5 float-start" value="Login">
                                    <div id="register-link " class="text-right float-end">
                                        <a href="registracija.php" class="text-info">Registracija</a>
                                    </div>
                                </div>
